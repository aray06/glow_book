...
<div class="max-w-7xl mx-auto px-4 py-12">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-stone-200 hover:shadow-md hover:border-gold/30 transition-all">
            ...
            <p class="text-stone-500 text-sm mt-2 leading-relaxed">{{ $service->description }}</p>
            ...
            <div class="flex items-center justify-between mt-4 pt-3 border-t border-stone-100">
                ...
                @auth<a href="{{ route('client.book', ['salon_id' => $service->salon_id, 'service_id' => $service->id]) }}" class="btn-gold text-white px-4 py-1.5 rounded-2xl text-sm font-semibold transition">Book</a>@else<a href="{{ route('login') }}" class="btn-gold text-white px-4 py-1.5 rounded-2xl text-sm font-semibold transition">Book</a>@endauth
            </div>
        </div>
        @endforeach
    </div>
